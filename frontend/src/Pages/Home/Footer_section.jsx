...
const Footer = () => {
  return (
    <footer className="bg-[#f1f5f9] text-slate-800 pt-16 pb-10 px-6 md:px-20 relative z-10 border-t border-slate-200">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 animate-fade-in">
        ...
        <div>
          ...
          <div className="flex items-center space-x-3 text-sm text-gray-700 mb-2">
            ...
            <span>support@medlitech.in</span>
          </div>
      ...
      {/* Footer Bottom */}
      <div className="mt-12 text-center text-sm text-gray-500 border-t border-slate-300 pt-6">
        © {new Date().getFullYear()} Medlitech. All rights reserved. | Powered by <span className="text-blue-800 font-semibold">Radha Krishna Singh</span>
      </div>
    </footer>
  );
};
